...
<body>
	...
	<div class="container cuerpo-APJ">
		<section class="main row">
			<form class="section-APJ" method="POST" action="../../procesamientos/jefe/proAceptarPermiso.php">
				<legend>Solicitud de Permiso</legend>
				<div class="form-group datos1-APJ">
						<dt>
							<dd style="font-weight: bold">Nombre del Empleado:</dd>
								<dl id= "nombreEmpleado"></dl>	
							<dd style="font-weight: bold">Tipo de Permiso:</dd>
								<dl id= "tipoPermiso"></dl>
							<dd style="font-weight: bold">Motivo del Permiso:</dd>
								<dl><p id= "motivoPermiso"></p></dl>
							<dd style="font-weight: bold">Fecha de solicitud:</dd>
								<dl id= "fechaSolicitud"></dl>
							<dd style="font-weight: bold">Período de permiso:</dd>
	...
	<?php 	include("../../procesamientos/jefe/proMostrarPermiso.php"); ?>

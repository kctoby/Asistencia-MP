...
<head>
	...
	<script src="../js/personal/paginacion.js"></script>
	...
	<nav class="navbar navbar-inverse">
	  	<div class="container-fluid">
	    	<div class="navbar-header">
	    		<div class="logo">
	      			<img class="imagen-bloque" src="../Imagenes/LogoMP.png" alt="" align="left" height="60">
	      		</div>
		...
		<section class="main row">
			<div class="col-md-8 opciones-PP">
				...
				<section class="main row">
					<form class="form-horizontal">
	  					<legend>Administrar Sistema</legend>
	    				</br></br>
	    				</br></br>
	    				</br></br>
	    				...
	    				<div class="form-group" align="center">
	      					...
	      					<div class="col-lg-8 posicion-botones-JE" >
								<a href="personal/buscarEmpleado.php" class="btn btn-primary  tam-boton-PP">Buscar Empleado</a>
								</br></br>
								<a href="personal/planilla.php" class="btn btn-primary btn-lg tam-boton-PP">Planilla</a>	
								</br></br>
								<a href="personal/revertirPermiso.php" class="btn btn-primary btn-lg tam-boton-PP">Revertir Permiso</a>	
								</br></br>
								<a href="personal/administrarSistema.php" class="btn btn-primary btn-lg tam-boton-PP">Administrar Sistema</a>
								</br></br>	
				      		</div>
				      		</br></br>
	    				</div>
			...
			<div class="col-md-4 lista-permiso-PP">
				...
				<div>
					...
					<a href="../procesamientos/personal/proBuscarPermiso.php" onclick="enviarIdEncotrado()"><img class="btn-lupa ubica-lupa" src="../Imagenes/Lupa.png" height="35"></a>
				</div>
...
<?php 
	include("../procesamientos/personal/proPermisosPersonal.php");
?>

...
--Lista de Horarios que el empleado esta asignado.
CREATE OR REPLACE FUNCTION "PERMISOS".F_LISTA_NOMBRES_HORARIOS_ASIGNADO_EMPL(IN P_ID_EMPLEADO CHARACTER VARYING(10)) 
...
SELECT * FROM "PERMISOS".F_LISTA_NOMBRES_HORARIOS_ASIGNADO_EMPL('000028');